...
namespace UnityEngine.UI
{
    ...
    public abstract class LoopScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        public Action<Transform, int> SetItemAction = (t, i) => { Debug.Log(t.gameObject.name + " is " + i); };
        public Action<Transform> ResetItemAction { set { prefabSource.ResetItemAction = value; }}
        ...
        protected override void Awake()
        {
            ...
            content.GetChild(0).SetParent(source.transform);        }
        //==========LoopScrollRect==========
        ...
        public void RefreshCells()
        {
            if (Application.isPlaying && isActiveAndEnabled)
            {
                ...
                for (int i = 0; i < content.childCount; i++)
                {
                    ...
                    {
                        SetItemAction(content.GetChild(i), itemTypeEnd);
        ...
        {            
            ...
            SetItemAction(nextItem, itemIdx);
